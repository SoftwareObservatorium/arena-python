...
def test_srm_base64_external_functions():
    ...
    c1 = CodeCandidate("917239ca-5093-44a6-a284-64e1acb8ccac", "", f"{base_folder}/917239ca-5093-44a6-a284-64e1acb8ccac/candidate.py")
    c2 = CodeCandidate("c108afda-e52c-454b-a7ed-c05f48257a9b", "", f"{base_folder}/c108afda-e52c-454b-a7ed-c05f48257a9b/candidate.py")
    c3 = CodeCandidate("c9571f41-161b-46ed-a528-941d96a0dd2b", "", f"{base_folder}/c9571f41-161b-46ed-a528-941d96a0dd2b/candidate.py")
    cuts = import_classes_under_test([c1, c2, c3])
